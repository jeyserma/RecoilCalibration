...
def dummy(nbins = 1):
    ...
    # x-axis
    dummy.GetXaxis().SetTitle(cfg['xtitle'])
    ...
    # y-axis
    dummy.GetYaxis().SetTitle(cfg['ytitle'])
...
def dummyRatio(nbins = 1, line=1):
    ...
    dummyB.GetXaxis().SetTitleOffset(1.0*dummyB.GetXaxis().GetTitleOffset()) ### was 4.0???
    dummyB.GetXaxis().SetLabelOffset(3.0*dummyB.GetXaxis().GetLabelOffset())

    # y-axis
    dummyT.GetYaxis().SetTitle(cfg['ytitle'])
    dummyB.GetYaxis().SetTitle(cfg['ytitleR'])
